...
if (URL_KO_JS_ORG.endsWith("localhost")) {
  app.use("/ws-node/devices", express.static(path.join(__dirname, "ws-node", "devices")));
  app.use("/ws-node/html", express.static(path.join(__dirname, "ws-node", "html")));
}
